...
class BannerAdView(var activity: Activity,
    ...
    override fun onAdReady(p0: AdView?) {
        if (p0 == null) {
            Log2Util.e("$TAG  Banner广告加载失败 adView不存在或已销毁")
